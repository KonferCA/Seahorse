...
import googleIcon from '@/app/components/icons/google.svg';
...
export default function GoogleDataPanel({ onDataReceived }: GoogleDataPanelProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6 mb-4">
      <h3 className="text-lg font-semibold text-gray-800 mb-4">Import Google Data</h3>
      ...
      >
        <Image src={googleIcon} alt="Google icon" className="w-5 h-5" width={20} height={20} />
